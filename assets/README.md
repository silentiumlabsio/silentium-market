...
Only sanitized, non-sensitive media belongs in this directory.

Do not add screenshots containing private account information, local paths, session data, credentials, private tester names, or proprietary implementation details.
